...
const Item = class {
  ...
  componentWillLoad() {
    this.inheritedAriaAttributes = (0,_helpers_78efeec3_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, ['aria-label']);
  }
  componentDidLoad() {
...
const SkeletonText = class {
  ...
  render() {
    const animated = this.animated && _ionic_global_ca86cf32_js__WEBPACK_IMPORTED_MODULE_5__.c.getBoolean('animated', true);
