...
`, this.el);
    ...
    this.animateToDate = /*#__PURE__*/function () {
      var _ref = (0,_Users_t_r_a_v_s_Downloads_cognito_capacitor_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (targetValue) {
        const {
          workingParts
        } = _this;
        /**
  ...
  confirm() {
    var _this3 = this;
    return (0,_Users_t_r_a_v_s_Downloads_cognito_capacitor_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (closeOverlay = false) {
      const {
        isCalendarPicker,
        activeParts,
        preferWheel,
  ...
  renderTimeOverlay() {
    ...
    return [(0,_index_527b9e34_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      disabled: disabled,
      onClick: function () {
        var _ref2 = (0,_Users_t_r_a_v_s_Downloads_cognito_capacitor_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
          const {
            popoverRef
          } = _this6;
          if (popoverRef) {
  ...
  callButtonHandler(button) {
    ...
    return (0,_Users_t_r_a_v_s_Downloads_cognito_capacitor_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button) {
        ...
        const rtn = yield (0,_overlays_41a5d51b_js__WEBPACK_IMPORTED_MODULE_11__.s)(button.handler, _this0.getSelected());
        if (rtn === false) {
...
const PickerColumnCmp = class {
  ...
  connectedCallback() {
    ...
    return (0,_Users_t_r_a_v_s_Downloads_cognito_capacitor_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const mode = (0,_ionic_global_ca86cf32_js__WEBPACK_IMPORTED_MODULE_8__.b)(_this1);
      if (mode === 'ios') {
      ...
      _this1.gesture = (yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./index-39782642.js */ 32976))).createGesture({
        el: _this1.el,
