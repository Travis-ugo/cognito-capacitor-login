  ...
  transition(enteringView, leavingView, ti) {
    ...
    return (0,_Users_t_r_a_v_s_Software_cognito_capacitor_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const animationOpts = Object.assign(Object.assign({
        ...
        baseEl: _this1.el,
        progressCallback,
        animated: _this1.animated && _ionic_global_ca86cf32_js__WEBPACK_IMPORTED_MODULE_4__.c.getBoolean('animated', true),
        enteringEl,
        leavingEl
      }, opts), {
        animationBuilder: opts.animationBuilder || _this1.animation || _ionic_global_ca86cf32_js__WEBPACK_IMPORTED_MODULE_4__.c.get('navAnimation')
      });
      const {
        hasCompleted
