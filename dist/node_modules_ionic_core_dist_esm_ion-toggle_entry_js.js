...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.didLoad = false;
    this.setupGesture = /*#__PURE__*/(0,_Users_t_r_a_v_s_Downloads_cognito_capacitor_login_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        toggleTrack
      } = _this;
      if (toggleTrack) {
    ...
    this.value = 'on';
    this.enableOnOffLabels = _ionic_global_ca86cf32_js__WEBPACK_IMPORTED_MODULE_7__.c.get('toggleOnOffLabels');
  ...
  renderToggleControl() {
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_527b9e34_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  render() {
    ...
    return (0,_index_527b9e34_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_527b9e34_js__WEBPACK_IMPORTED_MODULE_1__.e, {
      ...
      required: required
    }, this.inheritedAttributes)), (0,_index_527b9e34_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
